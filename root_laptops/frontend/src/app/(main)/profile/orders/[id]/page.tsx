...
interface OrderItem {
  _id: string;
  watch_id: Product; // Populated product details
  quantity: number;
                  ...
                  <TableRow key={item._id}>
                    <TableCell className="font-medium">
                      <div className="flex items-center">
                        <img src={item.watch_id.images.mainImg.url} alt={item.watch_id.name} className="w-12 h-12 object-cover rounded-md mr-3" />
                        <span>{item.watch_id.name}</span>
                      </div>
                    </TableCell>
                    <TableCell>{item.watch_id.name}</TableCell>
